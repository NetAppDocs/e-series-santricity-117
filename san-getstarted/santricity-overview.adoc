...
* SANtricity System Manager -- a web-based interface used for managing one controller in a storage array.
* SANtricity Unified Manager -- a web-based interface used for viewing and managing all storage arrays in your network.
